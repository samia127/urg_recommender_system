...
These helpers keep notebook cells focused on orchestration while handling
robust parsing, defaults, and missing-data resilience.
"""
...
def load_majors_data(json_path: str) -> pd.DataFrame:
...
def load_context(txt_path: str) -> Dict[str, object]:
